...
# Note: the LS factor is the average long-short portfolio across
# the first sorting variable 
# e.g., in this case, .get_long_short() gives you the average factor return
# across the RATING_NUM sorts
# Currently, this is an unconditional sort
# Conditional sorts coming soon.

Strategies_LS = pd.concat(RESULTS.get_long_short(),axis=1)
print(Strategies_LS.mean()*100)
