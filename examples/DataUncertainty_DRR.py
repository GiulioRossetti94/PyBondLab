...
# wrds_username = 'giulior' # Input your WRDS username
...
# tbl1.to_csv('wrds_bondret_temp.csv')  # save a copy locally
...
# print('Original length:', len(tbl1)) 
...
# =============================================================================
# TODO: Update this path to point to your local WRDS bond data file
# Data can be obtained from WRDS (requires institutional access)
data_path = "path/to/your/bondret_new.csv"
tbl1 = pd.read_csv(data_path)  # Load the data saved from WRDS
...
mom33 = pbl.Momentum(holding_period=3, lookback_period=3, skip=skip, num_portfolios=n_portf,verbose=False)
#(6,6): signal is computed as the cumulative return over the J=6 previous months skipping the most recent observation (skip = 1). 
mom66 = pbl.Momentum(holding_period=6, lookback_period=6, skip=skip, num_portfolios=n_portf,verbose=False)
...
# =============================================================================
# Equal-Weight
pd.concat(l_ew_ea, axis = 1).to_csv(r'exante_momentum_uncertainty_ew_NIG.csv')
pd.concat(l_ew_ep, axis = 1).to_csv(r'expost_momentum_uncertainty_ew_NIG.csv')

# Value-Weight
pd.concat(l_vw_ea, axis = 1).to_csv(r'exante_momentum_uncertainty_vw_NIG.csv')
pd.concat(l_vw_ep, axis = 1).to_csv(r'expost_momentum_uncertainty_vw_NIG.csv')
# =============================================================================
